...
/**
 * Mục đích: Kiểm tra API endpoint đăng nhập
 */
...
class AuthControllerTest {
    ...
    void login_Failed_AccountNotFound() throws Exception {
        // Arrange
        LoginRequest request = new LoginRequest("nonExistentUser", "password123", 1L);
    ...
    private static Stream<Arguments> provideInvalidLoginRequests() {
        return Stream.of(
                Arguments.of(new LoginRequest("", "password123", 1L), "username"),
                Arguments.of(new LoginRequest("   ", "password123", 1L), "username"),
                Arguments.of(new LoginRequest("testUser", "", 1L), "password"),
                Arguments.of(new LoginRequest("testUser", "   ", 1L), "password"),
                Arguments.of(new LoginRequest("testUser", "password123", null), "warehouseId"),
                Arguments.of(new LoginRequest(null, "password123", 1L), "username"),
                Arguments.of(new LoginRequest("testUser", null, 1L), "password")
        );
    }
    ...
    void login_WarehouseIdZero() throws Exception {
        // Arrange
        LoginRequest request = new LoginRequest("testUser", "password123", 0L);
